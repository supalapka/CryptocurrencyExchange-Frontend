  ...
  <thead >
    <tr class="cryptocurrency" >
      ...
      <th style="width: 300px;" >
        <p class="cryptocurrency-name">{{coin.name}}</p></th>
      <th style="width: 110px;">
        <p :class="parseFloat(this.coin.P) > 0 ? 'cryptocurrency-change positive' : 'cryptocurrency-change negative'">{{parseFloat(this.coin.P).toFixed(2)}}%</p>
      </th>
